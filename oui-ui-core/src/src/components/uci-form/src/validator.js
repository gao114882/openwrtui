...
function performCallback(types, rule, value, cb, msg, arg) {
  ...
  if (types[rule.type].verify(value, arg)) cb()
...
const types = {
  ...
  integer: {
    verify: value => {
      return (
        types['number'].verify(value) && parseInt(value).toString() === value
      )
    },
    validator: (rule, value, cb) => {
  ...
  uinteger: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a positive integer')
      )
    }
  },
  min: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a number greater or equal to', { num: rule.arg }),
        rule.arg
      )
    }
  },
  max: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a number lower or equal to', { num: rule.arg }),
        rule.arg
      )
    }
  },
  range: {
    verify: (value, arg) => {
      return (
        types['min'].verify(value, arg[0]) && types['max'].verify(value, arg[1])
      )
    },
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a number between', {
          min: rule.arg[0],
          max: rule.arg[1]
        }),
        rule.arg
  ...
  hostname: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid hostname')
      )
    }
  },
  ip4addr: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid IPv4 address')
      )
    }
  },
  ip6addr: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid IPv6 address')
      )
    }
  },
  ipaddr: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid IP address')
      )
    }
  },
  netmask4: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid IPv4 netmask')
      )
    }
  },
  netmask6: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid IPv6 netmask')
      )
    }
  },
  host: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid hostname or IP address')
      )
    }
  },
  port: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid port number')
      )
    }
  },
  macaddr: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid MAC address')
      )
    }
  },
  uciname: {
    ...
    validator: (rule, value, cb) => {
      performCallback(
        ...
        value,
        cb,
        i18n.t('Must be a valid UCI identifier')
      )
    }
  }
}
...
validator.compileFunction = function(verify, vm) {
  const r = {
    validator: (rule, value, callback) => {
      ...
      if (typeof err === 'string') callback(new Error(err))
      else callback()
    }
  }
