  ...
  <div>
    <el-header class="header"
      ...
      <el-breadcrumb separator="/"
                     class="crumbs">
        <el-breadcrumb-item v-for="(item, i) in breadcrumbs"
                            :key="i"
                            :to="item.to">{{ $t(item.title) }}</el-breadcrumb-item>
      </el-breadcrumb>
      <div class="header-right">
        <el-tooltip effect="dark"
                    :content="isfullScreen ? $t('Exit Full Screen') : $t('Full Screen')"
                    placement="bottom">
          <i class="iconfont iconfull"
             @click="fullScreen"></i>
        </el-tooltip>
        <el-dropdown @command="onLangCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="en"
                              :icon="(lang === 'en') ? 'el-icon-arrow-right' : ''">English</el-dropdown-item>
            <el-dropdown-item command="zh-CN"
                              :icon="(lang === 'zh-CN') ? 'el-icon-arrow-right' : ''">中文</el-dropdown-item>
            <el-dropdown-item command="auto"
                              :icon="(lang === 'auto') ? 'el-icon-arrow-right' : ''">{{ $t('Automatic') }}</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
