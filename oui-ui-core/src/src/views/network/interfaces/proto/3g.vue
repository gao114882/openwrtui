<template>
  <div>
    <uci-option-list tab="general"
                     :label="$t('Modem device')"
                     name="device"
                     :options="modemDevices"></uci-option-list>
    <uci-option-list tab="general"
    ...
    <uci-option-input tab="general"
                      label="APN"
                      name="apn"></uci-option-input>
    <uci-option-input tab="general"
                      label="PIN"
                      name="pincode"></uci-option-input>
    <uci-option-input tab="general"
                      :label="$t('PAP/CHAP username')"
                      name="username"></uci-option-input>
    <uci-option-input tab="general"
    ...
    <uci-option-input tab="general"
                      :label="$t('Dial number')"
                      name="dialnumber"
                      placeholder="*99***1#"></uci-option-input>
    <uci-option-input tab="advanced"
                      :label="$t('Modem init timeout')"
                      name="maxwait"
                      placeholder="20"
                      :rules="{type: 'integer', min: 1}"></uci-option-input>
